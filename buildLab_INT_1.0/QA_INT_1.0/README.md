# QA INT 1.0 workspace

This folder contains weekly evidence for the QA track. The learning guidance is maintained in [buildLab_resources](../../buildLab_resources/QA_esources/README.md).

## Contributors in the supplied roster

No named QA contributor was supplied. The temporary cross-functional seat is documented once at [DevOps_INT_1.0/TBD_MEMBER_12](../DevOps_INT_1.0/TBD_MEMBER_12/); do not duplicate that weekly folder here.

## Required folder structure

Each GitHub username folder contains exactly 24 weekly folders:

`QA_INT_1.0/<github-username>/W-01/README.md` through `W-24/README.md`
